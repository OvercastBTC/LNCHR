...
class IUIAutomation ;extends IUnknown
{
	...
	; Note:Â Â Before implementing an event handler, you should be familiar with the threading issues described in Understanding Threading Issues. http://msdn.microsoft.com/en-us/library/ee671692(v=vs.85).aspx
...
class IUIAutomationElement
{
	...
	; â€¢ Call the GetClickablePoint method to find a clickable point on the control.
	; â€¢ Call the SendInput function to send a right-mouse-down, right-mouse-up sequence.
	GetClickablePoint(){
...
; variant type
VariantType(type){
	static _:={2:[2,"short"]	; 16 ä½æœ‰ç¬¦å·æ•´æ•°
	,3:[4,"int"]	; 32 ä½æœ‰ç¬¦å·æ•´æ•°
	,4:[4,"float"]	; 32 ä½æµ®ç‚¹æ•°
	,5:[8,"double"]	; 64 ä½æµ®ç‚¹æ•°
	,0xA:[4,"uint"]	; Error ç  (32 ä½æ•´æ•°)
	,0xB:[2,"short"]	; å¸ƒå°”å€¼ True (-1) æˆ– False (0)
	,0x10:[1,"char"]	; 8 ä½æœ‰ç¬¦å·æ•´æ•°
	,0x11:[1,"uchar"]	; 8 ä½æ— ç¬¦å·æ•´æ•°
	,0x12:[2,"ushort"]	; 16 ä½æ— ç¬¦å·æ•´æ•°
	,0x13:[4,"uint"]	; 32 ä½æ— ç¬¦å·æ•´æ•°
	,0x14:[8,"int64"]	; 64 ä½æœ‰ç¬¦å·æ•´æ•°
	,0x15:[8,"uint64"]}	; 64 ä½æ— ç¬¦å·æ•´æ•°
