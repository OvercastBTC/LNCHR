...
Class RTEdit {
	...
	; ---------------------------------------------------------------------------
	__New(*) {
		; this.GuiTitle := 'Horizon Rich Text Editor - hznRTE -- A Rich Text Editor for Horizon'
		; this.MainGui.GuiTitle := this.GuiTitle
	...
	; ---------------------------------------------------------------------------
	bBold(*){
		this.MainGui.SetFont("Norm Bold", this.Settings.FontName)
		...
		this.GuiCtrlSetTip(MainBNSB, "Bold (Ctl+B)")
		this.defaultFont()
