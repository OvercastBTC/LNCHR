...
RAlt:: ;Reload Script
Browser_Forward::Reload ;Reload Script
RControl:: ;Right Control to Get Text Under Mouse
Browser_Back:: ;Browser back button to Get Text Under Mouse
uia := UIA_Interface()
Element := uia.ElementFromPoint()

;for each, value in [30093,30092,30045] { ; lvalue,lname,value
for each, value in 30003 { ; lvalue,lname,value
...
Resizable_GUI(Clipboard:=r,600,400,0) ;Display results and copy to the clipboard
return
...
Resizable_GUI(value,x:=900,y:=600,eta:=false){
...
class UIA_Interface extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671406(v=vs.85).aspx
	...
	CreateTrueCondition() { ;~ CreateCacheRequest 	20
	...
	CreateAndConditionFromArray(array) { ; ComObj(0x2003)??  	;->in: AHK Array or Wrapped SafeArray
	...
	CreateOrConditionFromArray(array) { 	;->in: AHK Array or Wrapped SafeArray
		if ComObjValue(array)&0x2000
			SafeArray:=array
		else {
			SafeArray:=ComObj(0x2003,DllCall("oleaut32\SafeArrayCreateVector", "uint",13, "uint",0, "uint",array.MaxIndex()),1)
	...
	;~ SafeArrayToRectNativeArray 	46 	;~ CreateProxyFactoryEntry 	47
...
class UIA_Element extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671425(v=vs.85).aspx
	...
	GetCurrentPropertyValueEx(propertyId, ignoreDefaultValue=1, ByRef out="") { 	; Passing FALSE in the ignoreDefaultValue parameter is equivalent to calling GetCurrentPropertyValue
...
class UIA_ElementArray extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671426(v=vs.85).aspx
...
class UIA_TreeWalker extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671470(v=vs.85).aspx
...
class UIA_PropertyCondition extends UIA_Condition { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696121(v=vs.85).aspx
...
class UIA_AndCondition extends UIA_Condition { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671407(v=vs.85).aspx
...
class UIA_OrCondition extends UIA_Condition { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696108(v=vs.85).aspx
	static __IID := "{8753f032-3db1-47b5-a1fc-6e34a266c712}"
		,  __properties := "ChildCount,3,int"
}
class UIA_BoolCondition extends UIA_Condition { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671411(v=vs.85).aspx
	static __IID := "{8753f032-3db1-47b5-a1fc-6e34a266c712}"
		,  __properties := "BooleanValue,3,boolVal"
}
class UIA_NotCondition extends UIA_Condition {	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696106(v=vs.85).aspx
	static __IID := "{f528b657-847b-498c-8896-d52b565407a1}"
}

class UIA_IUnknown extends UIA_Base {	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ms680509(v=vs.85).aspx
	static __IID := "{00000000-0000-0000-C000-000000000046}"
}

class UIA_CacheRequest  extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671413(v=vs.85).aspx
	static __IID := "{b32a92b5-bc25-4078-9c08-d7ee95c48e03}"
}


class _UIA_EventHandler { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696044(v=vs.85).aspx
	static __IID := "{146c3c17-f12e-4e22-8c27-f894b9b79c69}"
}
class _UIA_FocusChangedEventHandler {	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696051(v=vs.85).aspx
	static __IID := "{c270f6b5-5c69-4290-9745-7a7f97169468}"
}
class _UIA_PropertyChangedEventHandler {  ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696119(v=vs.85).aspx
	static __IID := "{40cd37d4-c756-4b0c-8c6f-bddfeeb13b50}"
}
class _UIA_StructureChangedEventHandler { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696197(v=vs.85).aspx
...
class _UIA_TextEditTextChangedEventHandler { ; Windows 8.1 Preview [desktop apps only]
	...
	static __IID := "{92FAA680-E704-4156-931A-E32D5BB38F3F}" 	;~ HandleTextEditTextChangedEvent	3
}


;~ 		UIA_Patterns - http://msdn.microsoft.com/en-us/library/windows/desktop/ee684023
class UIA_DockPattern extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee671421
...
class UIA_ExpandCollapsePattern extends UIA_Base {	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696046
...
class UIA_GridItemPattern extends UIA_Base { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696053
...
class UIA_GridPattern extends UIA_Base { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696064
...
class UIA_ItemContainerPattern extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696072
...
class UIA_LegacyIAccessiblePattern extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696074
...
class UIA_MultipleViewPattern extends UIA_Base { 	;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696099
...
class UIA_RangeValuePattern extends UIA_Base { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696147
...
class UIA_ScrollItemPattern extends UIA_Base { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696165
...
class UIA_ScrollPattern extends UIA_Base { ;~ http://msdn.microsoft.com/en-us/library/windows/desktop/ee696167
   ...
   ;~ UIA Functions
	...
	UIA_Hr(hr) { ;~ http://blogs.msdn.com/b/eldar/archive/2007/04/03/a-lot-of-hresult-codes.aspx
	...
	UIA_SafeArraysToObject(keys,values) { 	;~1 dim safearrays w/ same # of elements
		out:={}
		for key in keys
	...
	UIA_Variant(ByRef var,type=0,val=0) { 	; Does a variant need to be cleared? If it uses SysAllocString?
	...
	UIA_VariantData(ByRef p, flag=1) {	; based on Sean's COM_Enumerate function		; need to clear varaint? what if you still need it (flag param)?
