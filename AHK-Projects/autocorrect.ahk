...
; CHANGELOG:
;
; May 31 2023: Changed A_ScriptFullPath to this_script to file append to this script versus the main script (AHK Script.ahk)
...
;------------------------------------------------------------------------------
^#h::
SplitPath, % A_ScriptFullPath, this_FlNm,this_dir,this_ext,this_flnmNoExt
this_script:= "AutoCorrect.ahk"
MsgBox % this_dir this_script
return
...
;FileAppend, `n%Hotstring%, %A_ScriptFullPath%  ; Put a `n at the beginning in case file lacks a blank line at its end. ; modified to be this_script versus the #include script
FileAppend, `n%Hotstring%, %this_script%  ; Put a `n at the beginning in case file lacks a blank line at its end(AJB - 05/20)23
Reload
...
;-------------------------------------------------------------------------------
; Anything below this point was added to the script by the user via the Alt+Win+H hotkey.
;-------------------------------------------------------------------------------