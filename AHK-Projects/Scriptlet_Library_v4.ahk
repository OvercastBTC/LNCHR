...
DockToWindow:
  ...
  If (!EditorVisibleState AND Old_EditorVisibleState <> EditorVisibleState) {
      ...
      If GuiRolledUp
          Gui, 2:Show , AutoSize NoActivate    ;Show small bar when restored
      Else
          Gui, 1:Show , AutoSize NoActivate    ;Show gui when restored
      ...
      If GuiRolledUp {
          ...
          Gui, 1:Show, AutoSize x%EditorX% y%EditorY% NoActivate   ;otherwise move gui
        }
...
Gui, 1:Add, Edit, w500 h500 ys Multi T8 vEdtScriptletData gEdtScriptletData,
Gui, 1:Add, Button, vb1 gResize, Resize
Gui, Show
return

Resize:
GuiControl, Move, eEdtScriptletData, h500
...
;********************Resizing***********************************
1GuiSize:
GuiControl,1:Move,%EditWindow%,% "w" A_GuiWidth-30 " h" A_GuiHeight-25
return
FinishGUI:
Gui, 1:Show, AutoSize %Gui1Pos%, %ScriptName%
...
GoSub, FileScriptletsIntoGui
Gui, 1:Font, %FontSize%, %StrFontName% 
Gui, 1:Add, Edit, % "w" A_GuiWidth-30 " h" A_GuiHeight-25 ym Multi T8 vEdtScriptletData gEdtScriptletData,
GoSub, FinishGUI
Return
...
RollGuiUp(BarName, vertical = "") {
    ...
    Gui, 2: +ToolWindow -SysMenu +AlwaysOnTop +AutoSize
    If vertical
