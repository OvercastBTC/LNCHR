...
updateTrayMenu()
trayNotify(script_full_name . " started", "Open keyboard shortcuts with {Ctrl + Shift + Alt + \}`n`nModified with Nerd by Adam Bacon and Terry Keatts`nMade with ❤️ by Bibek Aryal.")
