...
timeDiff(startTime, finishTime) {
	startTime := tSaved := IniRead, tSaved, %root%lib\LastSaved.ini, SavedVariables, LastSaved
	finishTime := A_Now
	...
	finish :=  %A_Now% finishhour ":" finishminute ":" finishsecond ;20000101 finishhour finishminute "00"
	...
	;T += finish,Seconds
	;Th := SubStr(T, 9, 2)
	;Tm := SubStr(finishTime, 11, 2)
	;Ts := SubStr(finishTime, 13, 2)
	;FormatTime, LastSaved, %T%, hh:mm:ss
	;MsgBox % LastSaved
	;return, LastSaved
}
