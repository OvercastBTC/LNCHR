CreateImageList()
Width:=85,XPos:=115,WinHeight:=230
...
Gui,Add,Text,x48 y10, % "Drag the Finder Tool over a window to select it.`nThen release the mouse"
Gui,Add,Text,x28 y+20 w%Width% h23 +0x202, % "Handle:"
Gui,Add,Edit,vEdtHandle HWNDEditHWND ReadOnly x%XPos% yp w356 h21
...
Gui,Add,Button,% "gShowFindDlg x" XPos " w84 h24", % "&Find..."
Gui,Add,Button,% "gTreeVis x" XPos+90 " yp w84 h24", % "&Tree..."
