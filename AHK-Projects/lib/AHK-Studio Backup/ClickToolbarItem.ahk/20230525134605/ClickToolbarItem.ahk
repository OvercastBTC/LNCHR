...
ToolTip, Unique ID: ahk_id %id%`nClass: ahk_class %class%`nControl: %control%`nActive Control: %ActiveWin%`nCH: %CursorHwnd%`nCTRL+WIN+T to Toggle On and Off`nCTRL+F12 to Copy to Clipboard, ,0
;[Original]
