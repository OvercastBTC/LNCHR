...
ControlGetFocus, fCtl, % "ahk_id " ihCtl
;nCtl:=Process, Exist, Name
WinGetTitle, nCtl, A
;ControlGet, Ctl, hWnd,, %hCtl%, A

ToolTip % "Instant: " ihCtl " | " "Control: " hCtl " | " "ahk_id " ctl "`nFocus: " fCtl " | " "Name: " nCtl "`rX:" x " Y:" y, x+1, y+1
Return
...
*/
#1::
SendMessage, % TB_PRESSBUTTON := 0x401, %hToolbar%, true, , ahk_id %hToolbar%
return
#2::
