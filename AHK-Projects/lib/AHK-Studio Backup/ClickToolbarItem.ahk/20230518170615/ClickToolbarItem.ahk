...
Return
;ControlGet, hToolbar, hWnd,, hCtl, A
SendMessage, % TB_BUTTONCOUNT := 0x418, 0, 0, , ahk_id %Ctl%
;SendMessage, % TB_PRESSBUTTON := 0x401, 2, true, , ahk_id %hToolbar%
ToolTip % hToolbar ? "Toolbar handle: " hToolbar "`nhCtl: " hCtl "`nButton count: " ;&& ErrorLevel : "Didn't find toolbar!"
return
