...
Loop, Parse, vCtlList, `n
{
	...
	vOutput .= A_Index ": Focus: " vCtlClassNN "| Parent: " vWinClass1 "| Root: " vWinClass2 "| Owner: " vWinClass3 "| Child: " vWinClass4 "| WindowFromPoint: " vWinClass5 "`n" ": vCtlClass: " vCtlClass
}
