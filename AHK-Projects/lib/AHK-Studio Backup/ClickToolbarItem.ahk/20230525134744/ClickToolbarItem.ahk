...
ToolTip, Unique ID: ahk_id %id%`nClass: ahk_class %class%`nControl: %control%`nActive Control: %ActiveWin%`nCTRL+WIN+T to Toggle On and Off`nCTRL+F12 to Copy to Clipboard, ,0
;[Original]
