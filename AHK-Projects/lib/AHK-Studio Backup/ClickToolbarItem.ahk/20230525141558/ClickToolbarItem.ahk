...
WatchCursor:
vToggleCopy:="CTRL+WIN+T to Toggle On and Off`nCTRL+F12 to Copy to Clipboard"
MouseGetPos,,,vWin,hCtl
ControlGet, Ctl, hWnd,, %hCtl%, A
;MsgBox % "Win: " win " | " "Children: " children
;CursorHwnd := DllCall("WindowFromPoint", "int64", CursorX | (CursorY << 32), "Ptr")
MouseGetPos,x,y, id,control
WinGetTitle, title, ahk_id %hCtl%
WinGetClass, class, ahk_id %Ctl%
ControlGetFocus, ActiveWin, A
ControlGet, List,List,,%wt%
ControlGet, Checked,Checked,,%hCtl%
ControlGet, Enabled,Enabled,,%hCtl%
ControlGet, Visible,Visible,,%hCtl%
ControlGet, Tab,Tab,,%hCtl%
ControlGet, FindString,FindString,*,%hCtl%
ControlGet, Choice,Choice,,%wt%
ControlGet, LineCount,LineCount,,%hCtl%
ControlGet, CurrentLine,CurrentLine,,%hCtl%
ControlGet, CurrentCol,CurrentCol,,%hCtl%
ControlGet, Line,Line,*,%hCtl%
ControlGet, Selected,Selected,,%hCtl%
ControlGet, Style,Style,,%hCtl%
ControlGet, ExStyle,ExStyle,,%hCtl%
ControlGet, Hwnd,Hwnd,,%Ctl%
win := WinEnum(%hWnd%) ; calls EnumWindows
children := WinEnum("A") ; enumerate child windows of the active window
ToolTip % "CH:  " CursorHwnd "`nList: " List "`nChecked: " Checked "`nEnabled :" Enabled "`nVisible: " Visible "`nTab: " Tab "`n`nFindString: " FindString "`nChoice: " Choice "`nLineCount: " LineCount "`nCurrentLine: " CurrentLine "`nCurrentCol: " CurrentCol "`nLine: " Line "`nSelected: " Selected "`nStyle: " Style "`nExStyle: " ExStyle "`nHwnd: " Hwnd "`nx: " x "`ny: " y `n"`nList: " List "`nChecked: " Checked "`nEnabled: " Enabled "`nVisible: " Visible "`nTab: " Tab "`nHwnd: " Hwnd "`nx: " x "`ny: " y "Title: " title "`n" "Unique ID: ahk_id " id "`n" "Class: ahk_class " class "`n" "Control: " control "`n" "Active Control: " ActiveWin "`n" "Instructions:`n" vToggleCopy "`n" "Win: " win " | " "Children: " children "`nvWin: " vWin " | Ctl: " Ctl, ,0,%this%
