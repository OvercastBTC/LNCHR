...
ToolTip % "Unique ID: ahk_id " id "`n" "Class: ahk_class " class "`n" "Control: " control "`n" "Active Control: " ActiveWin "`n" "Instructions" vToggleCopy "`n" "Win: " win " | " "Children: " children, ,0,%this%
;[Original]
