...
ToolTip Control: %hCtl% ahk_id %ctl%`nFocus: %fCtl%`nName: %nCtl%`rX: %x% Y: %y%, x+1, y+1
Return
...
Loop, Parse, vCtlList, `n
{
	...
	WinGetClass, vWinClass3, % "ahk_id " hWndOwner
	WinGetClass, vWinClass4, % "ahk_id " hWndChild
	vOutput .= A_Index ":" "`r" vCtlClassNN "`r`n" vWinClass4 "`r`n" ;"|" vWinClass1 "|" vWinClass2 "|" vWinClass3 "|" vWinClass4 "`r`n" ;"|" vWinClass4 "`r`n"
}
Clipboard := vOutput 
;ToolTip, % vCtlClassNN,x+1,0
ToolTip, % vOutput, xm,0
