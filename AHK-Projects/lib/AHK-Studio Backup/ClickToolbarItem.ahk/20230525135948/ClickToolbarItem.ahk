...
win := WinEnum(%Ctl%) ; calls EnumWindows
...
ToolTip % "Unique ID: ahk_id " id "`n" "Class: ahk_class " class "`n" "Control: " control "`n" "Active Control: " ActiveWin "`n" "Instructions:`n" vToggleCopy "`n" "Win: " win " | " "Children: " children "`nvWin: " vWin " | Ctl: " Ctl, ,0,%this%
;[Original]
