...
;DllCall("GetClassName","Ptr",Ctl,"Str",vWinClass2,"Int",261)
hWnd := DllCall("GetClassName","Ptr",Ctl,"Str",,"Int",261)
...
if (ErrorLevel != 1) {
	...
	MsgBox 0x40010, Error, % "SendMessge Error: " ErrorLevel "`n" vCtl "`n" hWnd ;vWinClass2
}
;MsgBox % vCtl
/*
