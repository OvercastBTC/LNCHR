...
;SendMessage, 0x00B1,"","", ,% "ahk_id " Ctl
;SendMessage, 0x00B1,0,-1, ,% "ahk_id " Ctl
...
NumPut(Value[1], &CHARRANGE,0,"Int")
NumPut(Value[2], &CHARRANGE,4,"Int")
DllCall("SendMessage","Ptr",Ctl,"UInt",0x0437, "Ptr", 0, "Ptr", &CHARRANGE)
