...
EnumToolbarButtons(ctrlhwnd, is_apply_scale:=false) {
	...
	*/
	...
	Loop,%buttons%
	{
		...
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . "`n", _emeditor_toolbar_buttons.docx ; debug
		ToolTip, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . "`n" ; , _emeditor_toolbar_buttons.txt ; debug
		;KeyWait, LButton, D
