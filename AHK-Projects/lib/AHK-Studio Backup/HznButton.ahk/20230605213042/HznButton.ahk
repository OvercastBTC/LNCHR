...
; . Continued ..: ===== where underline is an option is index 9 or 10, else it reverts to CTRL+B 
; ----------------------------------------------------------------------------------------------------------------------
...
MsgBox % thing:= SubStr(focus, 0, 1)
MsgBox % RegExMatch(TX112, "[0-9].$")
return
hIDx:= A_ThisHotkey = "^i" ? 2 ; .. italic
	: A_ThisHotkey = "^b" ? 1 ; .. bold = 2 & 19
	...
	: A_ThisHotkey = "^z" ? 17 ; undo = 17 and 18 ==> this may not be ideal to use... it doesn't operate the same
