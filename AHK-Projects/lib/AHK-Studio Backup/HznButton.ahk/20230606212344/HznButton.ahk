...
;Clipboard := % "InputLocaleID: " InputLocaleID
;Return

WinGet, WinID,, A
ThreadID:=DllCall("GetWindowThreadProcessId", "UInt", WinID, "UInt", 0)
InputLocaleID:=DllCall("GetKeyboardLayout", "UInt", ThreadID, "UInt")
MsgBox, % "ThreadID: " ThreadID "`nInputLocaleID: " InputLocaleID
Clipboard := % "ThreadID: " ThreadID "`nInputLocaleID: " InputLocaleID
return
...
Clipboard := % Format("Name:`t{}`nVK:`t{:X}`nSC:`t{:X}", name, vk, sc)
...
InputLocaleID: 0x4090409

ThreadID: 18052
InputLocaleID: 67699721
*/
/*									 
