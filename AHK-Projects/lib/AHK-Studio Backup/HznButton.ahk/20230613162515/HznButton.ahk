...
vhCtl := vCtl ~= ThunderRT6TextBox|TX11 ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
				: vCtl in TX11 ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1) ;EM_SETSEL:=0xB1
