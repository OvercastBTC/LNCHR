...
EnumToolbarButtons(ctrlhwnd, is_apply_scale:=false) {
	...
	*/
	...
	Loop,%buttons%
	{
		...
		SendMessage, %TB_GETBUTTONTEXT%, %idButton%, remote_buffer, , ahk_id %ctrlhwnd% ; hope that 4KB is enough
		...
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . "ErrorLevel: " ErrorLevel . "`n", _emeditor_hzntoolbar_buttons.txt ; debug
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . "ErrorLevel: " ErrorLevel . "`n", _emeditor_hzntoolbar_buttons.docx ; debug
		ToolTip, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . "ErrorLevel: " ErrorLevel . "`n" ; , _emeditor_toolbar_buttons.txt ; debug
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . "ErrorLevel: " ErrorLevel . "`n", _emeditor_toolbar_buttons.txt ; debug
		ToolTip,  % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . "ErrorLevel: " ErrorLevel . "`n" ;, _emeditor_toolbar_buttons.txt ; debug
		...
		FileAppend, % ( {"x":x1, "y":y1, "w":x2-x1, "h":y2-y1, "cmd":idButton, "text":BtnText} ) . "`n", _emeditor_testhzntoolbar_buttons.txt ; debug
		MsgBox, 1,, % "x: " x1 "," "y:" y1 "," "w:" x2-x1 "," "h:" y2-y1 "," "cmd:" idButton "," "text:" BtnText , 1
