...
vhCtl := vCtl = "ThunderRT6TextBox36" 							   ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1)
	: vCtl ~= "i)ThunderRT6TextBox|TX11" and != "i)ThunderRT6TextBox36" ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1) ;EM_SETSEL:=0xB1
