...
ControlGetFocus, hCtl, A
ControlGet, Ctl, hWnd,,% hCtl, A
;hWndChild := DllCall("RealChildWindowFromPointEX","Ptr",Ctl,"UInt",4,"Ptr")
CursorHwnd := DllCall("RealChildWindowFromPointEX", "int64", CursorX | (CursorY << 32), "Ptr")
Anc4 := DllCall("GetWindowThreadProcessId", "Ptr", CursorhWnd) ;, "UInt",, "Ptr")
hWndChild := DllCall("RealChildWindowFromPoint","Ptr",Ctl,"UInt",4,"Ptr")
VarSetCapacity(cClass, 261*2, 0)
VarSetCapacity(xycClass, 261*2, 0)
VarSetCapacity(4xycClass, 261*2, 0)
DllCall("GetClassName","Ptr",Ctl,"Str",cClass,"Int",261)
DllCall("GetClassName","Ptr",CursorHwnd,"Str",xycClass,"Int",261)
DllCall("GetClassName","Ptr",Anc4,"Str",4xycClass,"Int",261)
...
if (ErrorLevel != 1) {
	...
	MsgBox 0x40010, Error, % "SendMessge Error: " ErrorLevel "`n" vCtl "`n" cClass "`n:" xycClass 4xycClass
}
;MsgBox % vCtl
/*
