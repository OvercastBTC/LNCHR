...
EnumToolbarButtons(ctrlhwnd, is_apply_scale:=false) {
	...
	*/
	...
	Loop,%buttons%
	{
		...
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText .  " State: " btnstate . " Tip: " chr(Btntip) . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . " ErrorLevel: " ErrorLevel . "`n", _emeditor_toolbar_buttons.txt ; debug
		ToolTip,  % A_Index . ":" . idButton . "(" . btntextchars . ")" . " Txt: " BtnText . " State: " btnstate . " Tip: " chr(Btntip) . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . " ErrorLevel: " ErrorLevel . "`n" ;, _emeditor_toolbar_buttons.txt ; debug
