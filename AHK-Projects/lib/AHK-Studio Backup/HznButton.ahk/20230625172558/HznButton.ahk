...
EnumToolbarButtons(ctrlhwnd, is_apply_scale:=false) {
	...
	*/
	...
	Loop,%buttons%
	{
		...
		SendMessage, TB_GETTOOLTIPS := 1059, % idButton, 0, , % "ahk_id " ctrlhwnd ; hope that 4KB is enough ; just a test
		btntip := ErrorLevel
		;MsgBox, 1, , % btntip,1
		...
		FileAppend, % A_Index . ":" . idButton . "(" . btntextchars . ")" . BtnText .  " State: " btnstate . " Tip: " ASC(%Btntip%) . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . " ErrorLevel: " ErrorLevel . "`n", _emeditor_toolbar_buttons.txt ; debug
		ToolTip,  % A_Index . ":" . idButton . "(" . btntextchars . ")" . " Txt: " BtnText . " State: " btnstate . " Tip: " ASC(%Btntip%) . " X1: " x1 . " X2: " x2 . " Y1: " y1 . " Y2: " y2 . " ErrorLevel: " ErrorLevel . "`n" ;, _emeditor_toolbar_buttons.txt ; debug
