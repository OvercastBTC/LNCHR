...
WM_NCLBUTTONDOWN :=0x0201
WM_NCLBUTTONUP :=0x0202
SendMessage,WM_LBUTTONDOWN, ,, 100, ahk_id %hTbCtl%
SendMessage,WM_LBUTTONUP, ,, 100, ahk_id %hTbCtl%
...
EnumToolbarButtons(ctrlhwnd, is_apply_scale:=false) {
	...
	MsgBox % ControlGetPos, ctrlx, ctrly, ctrlw, ctrlh, , ahk_id %ctrlhwnd%
