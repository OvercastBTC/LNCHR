...
vhCtl := vCtl in ThunderRT6TextBox ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1) ;EM_SETSEL:=0xB1
				: vCtl in TX11 ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
	: vCtl in ThunderRT6textBox36 ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
							: DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
;vhCtl := vCtl in TX11 ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1) ;EM_SETSEL:=0xB1
;: DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
return
;vhCtl := vCtl = "ThunderRT6TextBox" or "TX11" ? DllCall("SendMessage","PTR",ctl,"UInt",0xB1) ;EM_SETSEL:=0xB1
;: DllCall("SendMessage","PTR",ctl,"UInt",0xB1, Ptr, 0, Ptr, -1) ;EM_SETSEL:=0xB1
;return
