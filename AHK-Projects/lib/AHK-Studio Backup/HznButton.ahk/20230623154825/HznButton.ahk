...
HznButton(hToolbar, n)
{
	...
	DllCall("SendMessage", "Ptr", hToolbar, "Str", 0x418, "Ptr", 0, "Ptr", 0) ;SendMessage, TB_BUTTONCOUNT, 0, 0, , ahk_id %hToolbar% ; count and load all the msvb_lib_toolbar buttons into memory
