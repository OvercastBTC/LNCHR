...
hotS:=% A_ThisLabel
global hotS
;MakeOSItalic(Trim(A_ThisLabel, ":"))1-1, Firesafe Building Construction and Materials 
;MsgBox % A_ThisLabel
If(a_process = "notepad.exe" or a_process = "notepad++.exe" or a_process = "AutoHotkey"*) ; Don't do italics in plain text editors
	{
		SendLevel 1
		IniRead, OS, OSTitle.ini, OS, % hotS
		Clipboard:=% OS A_Space
		Send ^v
		return
}
