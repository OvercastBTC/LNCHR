...
#IfWinActive ahk_group advanced_editors
return
#If
#IfWinActive ahk_group basic_editors
...
#If	
#IfWinActive ahk_group report_editors
	MakeOSItalic(OSTitle*)
	{
...
; ----------------------------------------------------------------------------------------------------------------------
#If WinActive("ahk_exe hznhorizonmgr.exe")
{
...
#If
; ----------------------------------------------------------------------------------------------------------------------
; Hotkey .....: Horizon Enter - Shift-Enter=Double Click
; ----------------------------------------------------------------------------------------------------------------------
...
MakeOSItalic(OSTitle)
{
	...
	If (process = "hznhorizon.exe"){
		...
		Sleep 100
		Gosub, ci
	} else if (process = notepad.exe or process = notepad++.exe){
		SendLevel, 1
		Send % OSSplit[2]
	}else {
		SendLevel, 1
