...
HznButton(hWndToolbar, n)
{
	...
	if (n >= 1 && n <= buttonCount) {
		...
		DllCall("PostMessage","PTR",hWndToolbar,"UInt",0x01, Ptr, (X+W//2), Ptr, (Y+H//2)) 	; do I work?
		DllCall("PostMessage","PTR",hWndToolbar,"UInt",0x02, Ptr, (X+W//2), Ptr, (Y+H//2)) 	; do I work?
