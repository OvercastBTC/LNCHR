...
Process_GetSystemHandles(sPidList:=%ctl%)
MsgBox % "list: " arrPids "`nErrorLevel: " ErrorLevel
...
#1::
;ToolTip
SendMessage,0x000E,0,0,% Ctl,% hCtl
OnMessage(0x000E, "MyMessageMonitor")
...
#8:::SetTimer, WatchCursor8, % (Toggle := !Toggle) ? 70 : "Off"
ToolTip
;#Persistent
