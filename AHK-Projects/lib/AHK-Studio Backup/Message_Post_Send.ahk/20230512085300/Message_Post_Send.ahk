...
ClickListViewItem(hWndToolbar, n) {
	static LVM_GETITEMCOUNT := 0x1004, TB_GETBUTTON := 0x417, LVM_APPROXIMATEVIEWRECT := 0x1040, LVM_GETSUBITEMRECT := 0x1038, LVM_GETSELECTEDCOUNT := 0x1032, LVM_GETITEMRECT := 0x100e, LVM_FIRST := 0x1000, LVM_GETNEXTITEM:= 0x100c						
	SendMessage, TB_BUTTONCOUNT, 0, 0, , ahk_id %hWndToolbar%
	buttonCount := ErrorLevel
	if (n >= 1 && n <= buttonCount) {
		DllCall("GetWindowThreadProcessId", "Ptr", hWndToolbar, "UIntP", targetProcessID)
