...
Loop, Parse, vCtlList, `n
{
	...
	vOutput .= A_Index ": Focus" vCtlClassNN "| Parent" vWinClass1 "| Root" vWinClass2 "| Owner" vWinClass3 "| Child" vWinClass4 "| I dunno" vWinClass5 "`r`n"
}
;Clipboard := vOutput 
;ToolTip, % vCtlClassNN,x+1,0
;ToolTip, % vOutput, xm,0
RegExMatch(%vOutput%, "msvb_lib_toolbar", vOutput2)
MsgBox, % vOutput "`n" vOutput2
return
*/
