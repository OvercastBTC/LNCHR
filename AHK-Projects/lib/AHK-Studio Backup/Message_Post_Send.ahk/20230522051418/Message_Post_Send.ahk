...
*/
^+1::
SetTimer,CursorhWnd, On

CursorhWnd:
WfPhWnd := DllCall("WindowFromPoint", "int64", CursorX | (CursorY << 32), "Ptr")
CwFpHwnd := DllCall("ChildWindowFromPoint", "int64", CursorX | (CursorY << 32), "Ptr")
ControlGet, CtlW, hWnd,,, % "ahk_pid" WfPhWnd
ControlGet, CtlC, hWnd,,, % "ahk_pid" CwFpHwnd
ToolTip % WfPhWnd ":" CtlW "`n" CwFpHwnd ":"CtlC
Return
/*
#If
*/
...
/*
	...
	Loop, Parse, vCtlList, `n
	{
		...
		vOutput .= A_Index ":" vCtlClassNN "|" vWinClass1 "|" vWinClass2 "|" vWinClass3 "|" vWinClass4 "|" vWinClass5 "`r`n"
	}
	Clipboard := vOutput 
