...
Loop, Parse, vCtlList, `n
{
	...
	WinGetClass, vWinClass3, % "ahk_id " hWndOwner
	WinGetClass, vWinClass4, % "ahk_id " hWndChild
	vOutput .= A_Index ":" "`nClassNN: " vCtlClassNN "`nhWndChild: " vWinClass4 "`nhWndChild: " hWndChild "`nhWndParent: " hWndParent "`nhWndRoot: " hWndRoot "`nhWndOwner" hWnedOwnder "`nCursorHwnd: " CursorHwnd ;"|" vWinClass1 "|" vWinClass2 "|" vWinClass3 "|" vWinClass4 "`r`n" ;"|" vWinClass4 "`r`n"
}
Clipboard := vOutput 
;ToolTip, % vCtlClassNN,x+1,0
ToolTip, % vOutput, xm,0
