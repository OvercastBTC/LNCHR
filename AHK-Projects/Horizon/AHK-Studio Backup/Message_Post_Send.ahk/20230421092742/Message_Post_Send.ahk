...
Gui, Add, Button, section vControl xm, ControlList & HWND
...
WinActivate, ahk_class ThunderRT6MDIForm
PostMessage, %Msg% , %wParam%, %lParam%, %Control%, ahk_id 0xFFFF ;, %WinText%, %ExcludeTitle%, %ExcludeText%
MsgBox %ErrorLevel%
return 
