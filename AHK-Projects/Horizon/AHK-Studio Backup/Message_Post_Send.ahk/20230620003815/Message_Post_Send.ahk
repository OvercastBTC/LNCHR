...
SendMessage, EM_SETCHARFORMAT	:=0x444, SCF_SELECTION :=1, CFM_ITALIC :=2,, ahk_id %hCtl%
return
^b::
...
ControlGet, hCtl, hWnd,,, A
DllCall("CHARFORMAT2A","Ptr",hCtl,"UInt",0x444,"Str",CFM_ALL,"Str",CFE_ITALIC)
return
#5::
WinGet, hWnd, ID, A
;WinGet, vCtlList, ControlList, % "ahk_id " hWnd
