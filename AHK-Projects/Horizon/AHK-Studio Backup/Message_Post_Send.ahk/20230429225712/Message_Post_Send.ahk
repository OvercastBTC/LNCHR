...
TestM:
PostMessage,201,,5,Button, ahk_class ThunderRT6MDIForm
Sleep 100
PostMessage,202,,5,Button, ahk_class ThunderRT6MDIForm
Sleep 100
;GuiControlGet, Msg,,,Edit
;GuiControlGet, wParam,,,Edit
;GuiControlGet, lParam,,,Edit
...
WinActivate, ahk_class ThunderRT6MDIForm
PostMessage, WM_USER + 7246 (0x0000204e) , 0, 0x0019e920,101, ahd_class msvb_lib_toolbar ;, %WinText%, %ExcludeTitle%, %ExcludeText%
;MsgBox Msg: %Msg%`nWParam: %wParam%`nlParam: %lParam%`nControlID: %ControlID%`nErrorLevel: %ErrorLevel%
return 
