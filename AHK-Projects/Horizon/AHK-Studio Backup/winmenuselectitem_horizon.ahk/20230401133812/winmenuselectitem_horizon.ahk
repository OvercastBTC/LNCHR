...
Gui,Color,Gray
Gui,1:Font,s11 Q4, Segoe UI Black
...
Gui, Add, Text, xm,Enter Code #:
Gui, Add, Text, x+40, |
Gui, Add, Text,x+10,Post (default) or Send?
Gui, Add, Edit, section R1 vInput xm+20 -5 W30, 
