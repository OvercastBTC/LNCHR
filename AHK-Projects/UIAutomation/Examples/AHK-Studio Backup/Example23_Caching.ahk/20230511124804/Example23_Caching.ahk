...
;Run, notepad.exe
WinWaitActive, ahk_exe hznhorizonmgr.exe

npEl:= UIA.ElementFromHandleBuildCache("ahk_exe hznhorizonmgr.exe", cacheRequest) ; Get element and also build the cache
