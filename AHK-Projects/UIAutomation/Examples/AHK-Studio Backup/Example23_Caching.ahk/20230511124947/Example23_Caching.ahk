...
;Run, notepad.exe
title:= WinWaitActive, ahk_exe hznhorizonmgr.exe or ahk_exe hznhorizon.exe

npEl:= UIA.ElementFromHandleBuildCache("ahk_exe "%title%, cacheRequest) ; Get element and also build the cache
