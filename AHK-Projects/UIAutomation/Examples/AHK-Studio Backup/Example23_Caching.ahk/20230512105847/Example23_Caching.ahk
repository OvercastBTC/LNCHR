...
cacheRequest.AddProperty("ControlType.Button")
...
npEl:= UIA.ElementFromHandleBuildCache("ahk_exe hznhorizon.exe", cacheRequest) ; Get element and also build the cache
