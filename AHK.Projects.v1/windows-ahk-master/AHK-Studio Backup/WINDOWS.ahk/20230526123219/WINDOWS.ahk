...
#Persistent ; Keeps script permanently running and prevent the script from exiting automatically.
...
runUIAutomation(){
	...
	Run, UIAViewer.ahk, C:\AHK-Studio\AHK-Projects\UIAutomation
}
runtxtundrmouse(){
...
runshellmessages(){
	...
	Run, Messages_Shell.ahk, C:\AHK-Studio\AHK-Projects\
}
runconstatine(){
	; run Constantine.ahk
...
updateTrayMenu() {
	...
	addTrayMenuOption("Run Messages_Shell.ahk", "runshellmessages")
	addTrayMenuOption()
