...
timeDiff(startTime, finishTime) {
	starthour := SubStr(startTime, 8, 2)
	startminute := SubStr(startTime, 10, 2)
	startsecond := SubStr(startTime, 12, 2)
	start := %tSaved% starthour ":" startminute ":" startsecond ;20000101 starthour startminute "00"
	MsgBox % start
	
	finishhour := SubStr(finishTime, 8, 2)
	finishminute := SubStr(finishTime, 10, 2)
	finishsecond := SubStr(finishTime, 12, 2)
