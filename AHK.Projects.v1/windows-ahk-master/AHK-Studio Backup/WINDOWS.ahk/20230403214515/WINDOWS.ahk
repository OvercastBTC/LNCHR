...
runScriptlet(){
	...
	Run, C:\AHK-Studio\AHK-Projects\Scriptlet_Library_v4.ahk
}
runAHKScript(){
	; run AHK Script.ahk
	;Run, C:\AHK-Studio\AHK-Projects\Includes.ahk
	;Sleep 500
	;Run, C:\AHK-Studio\AHK-Projects\AHK Script.ahk
}
...
timeDiff(startTime, finishTime) {
	...
	Ts := SubStr(T, 4, 2)
	if (Th !> 1 and Tm !>1)
		Return LastSaved:= %Ts%RBUTTONRBUTTON
	If (Th !> 1 and Tm > 1)
...
disable_enable:
SetTimer, disableTrayTip, -1250
SetTimer, enableTrayTip, -500
return
disableTrayTip:
Menu, Tray, NoIcon
return
