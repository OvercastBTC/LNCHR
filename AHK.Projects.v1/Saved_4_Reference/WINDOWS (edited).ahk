...
SetTimer, run_script_m, -750
run_script_m:
Run %root%%root_ahk%AHK Script.ahk
return
; ; for dev only
...
CountDown(var_in, delay = -1750){
	;SetTimer, HideTrayTip, -5000
	SetTimer, %var_in%, -%delay%
	return
}
...
runAtStartup() {
	if (FileExist(startup_shortcut)) {
		...
		SetTimer, disableTrayTip, -1750
		SetTimer, enableTrayTip, Off
