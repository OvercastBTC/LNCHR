/* Disabled due to VSCode => no longer needed
;=======================================================================================================================
; .............: Begin Section
...
Base_SaveReload()
{
	...
	;EnvGet, vUsr, USERPROFILE
	;EnvGet, vDrive, HOMEDRIVE
	;EnvGet, vPath, HOMEPATH
	; === quick test section ===
	;ToolTip % "UsrProf: " vUserProfile "`rHomeDrive: " vHomeDrive "`rHomePath: " vHomePath
	;return
	TargetFolder:= "C:\Users\bacona\OneDrive - FM Global\General - AutoHotKey User Group\Adams Buggy Betas"
	SourceFolder:= "C:\AHK-Studio"
	ResourceFolder:= "C:\Users\bacona\OneDrive - FM Global\3. AHK"
	LibraryFolder:= "C:\Users\bacona\OneDrive - FM Global\Documents\Autohotkey"
	...
	IniWrite, %A_Now%, % LibraryFolder "\lib\" LastSavedFile, SavedVariables, LastSaved
