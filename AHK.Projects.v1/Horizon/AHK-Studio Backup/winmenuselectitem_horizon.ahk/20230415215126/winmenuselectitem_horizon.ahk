...
Gui, Add, ListView, r20 w700, vMsg ;Edit, Section vMsg xm,					;Message box for Msg
...
^+!c:
ControlList:
WinGet, cList, ControlList, ahk_exe hznhorizon.exe
WinGet, cListH, ControlListHwnd, ahk_exe hznhorizon.exe
...
SendMessage, BM_SETSTATE,1,x15 y12,,ahk_exe hznhorizon.exe
MsgBox %ErrorLevel%`n %OutputVar% ;%Code1%`n%ahkid% %ctlid1%
TrayTip,Test Message, E: %ErrorLevel% & OPV: %OutputVar%, -500,R
return
