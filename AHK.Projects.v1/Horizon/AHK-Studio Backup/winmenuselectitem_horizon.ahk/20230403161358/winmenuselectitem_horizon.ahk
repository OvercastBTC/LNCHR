...
Gui,Add,Text, cAqua x5 y2 w30 h20 Border Center gTag, OC
;Gui,1:Font, s11 Underline Q4, Segoe UI Black
Gui,Add,Text,cGreen x60 y2 w120 h20 Border Center gMove_window,Move Window

;Gui,1:Font,s18 Q4, Segoe UI Black
...
Gui, Add, Edit, vMsg x+40,					;Message box for Msg
Gui, Add, Text,section R1 xm,wParam (optional):
Gui, Add, Edit, vWParam xm W30,
Gui, Add, Text,section R1 xm,lParam (optional):
Gui, Add, Edit, vLParam xm+40 W30,
Gui, Add, Text,xm,Control ID (optional):
Gui, Add, Edit, vControlID xm+80,
Gui, Add, Text,x+10,Post (default) or Send?
Gui, Add, Button, Default gPost x+95, &Post
Gui, Add, Button, vSend x+10, &Send
;Gui, Add, Edit, vInput xm+20 -5 W30, 
Gui, Add, Text, section x+20, Press "Enter" to continue...
...
GuiControlGet, Msg, vMsg, Edit
GuiControlGet, wParam,, vWParam, Edit
GuiControlGet, lParam,, vLParam, Edit
GuiControlGet, Send,, vSend, Edit
GuiControlGet, Post,, vPost, Edit
...
;============================== LE Guide Search Section ==============================
;MsgBox % search1
WinWaitActive, %FileName%  -  Read-Only - Excel, %FileName%  -  Read-Only
;WinWait, 1
Send, ^f
WinWaitActive, Find and Replace
Send, ^v
WinWaitActive, Find and Replace, % search1
Send !h
Send {Down}
Send {Enter}
KeyWait, Enter
