...
CoordMode, Mouse, Client
; italics button
PostMessage,0x0201,,50,, ahk_id %Ctlh% ;L_Button Down
PostMessage,0x0202,,50,, ahk_id %Ctlh% ;L_Button Down
return
...
WatchCursor:
MouseGetPos, , , tbctrl_name, control
MouseGetPos, , , tbctrl_ID, control, 3
WinGetTitle, title, ahk_id %id%
WinGetClass, class, ahk_id %id%
WinGet, ControlList, ControlList, A
;ToolTip, %ControlList%
ToolTip, ahk_id %id%`n ;ahk_class %class%`n%title%`nControl: %control%`nControlList: %ControlList%`n
...
ToolTip Control: %hCtl% ahk_id %ctl%, xm, 0
Return
