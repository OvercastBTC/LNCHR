...
;MsgBox Ctl: %Ctl% hCtl: %hCtl% win: %win%
;MouseGetPos,,,win, hCtl
global hCtl:="msvb_lib_toolbar1"
global hTxt:="TX111"
global hzn:="ahk_exe hznhorizon.exe"
winget, h_process, id, % Hzn
MsgBox % h_process
ControlFocus, ,ahk_id %h_process%
PostMessage, 0x0007,,,,ahk_id %h_process%  ; 0x0112 = WM_SYSCOMMAND, 0xF120 = SC_RESTORE
;PostMessage, 0x0007,0x0202,,,% h_process  ; 0x0112 = WM_SYSCOMMAND, 0xF120 = SC_RESTORE
;WinRestore ahk_exe hznhorizon.exe
Sleep 100
;SetMouseDelay, -500
;MouseClick, Left, xm, yp
PostMessage,0x0201,,,, ahk_exe hznhorizon.exe
PostMessage,0x0202,,,, ahk_exe hznhorizon.exe
ControlGet, Ctlh, hWnd,,% hCtl, A
ControlGet, Ctlt, hWnd,,% hTxt, A
;MsgBox % Ctl
CoordMode, Mouse, Client
PostMessage,0x0201,x5,y0,, ahk_id %Ctlh%
PostMessage,0x0202,x5,y0,, ahk_id %Ctlh%
;MsgBox % HWND
;Sleep 100
return
#7::
...
ToolTip Control: %hCtl% ahk_id %win%
Return
*/
#2::
