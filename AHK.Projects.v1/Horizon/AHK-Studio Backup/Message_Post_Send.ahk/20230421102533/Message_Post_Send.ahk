...
Gui, Add, Edit, vSearch1 x+15, ahk_class ThunderRT6CommandButton3
...
Gui, Submit,Nohide
WinActivate, ahk_class ThunderRT6MDIForm
PostMessage, %Msg% , %wParam%, %lParam%, %Control%, ahd_id %hwnd% ;, %WinText%, %ExcludeTitle%, %ExcludeText%
MsgBox Msg: %Msg%`nWParam: %wParam%`nlParam: %lParam%`nControlID: %ControlID%`nErrorLevel: %ErrorLevel%
return 
