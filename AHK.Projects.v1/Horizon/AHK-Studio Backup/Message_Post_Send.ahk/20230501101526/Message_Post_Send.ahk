...
WinGet, vCtlList, ControlList, % "ahk_id " control
WinGet, vCtlList, ControlList, % "ahk_id " hWnd
vOutput := ""
Loop, Parse, vCtlList, `n
{
	...
	WinGetClass, vWinClass4, % "ahk_id " CursorHwnd
	vOutput .= vCtlClassNN "|" vWinClass1 "|" vWinClass2 "|" vWinClass3 "|" vWinClass4 "`r`n"
}
Clipboard := vOutput
ToolTip, %vOutput%`n%CursorHwnd%
;MsgBox, % vOutput
...
return
#T::
SetTimer, wctry, % (Toggle:=!Toggle) ? "Off" : "On"
If Toggle
	ToolTip
Return
;#2::
