...
#1::
TestM:
ControlGet, window, msvb_lib_toolbar,,ahk_id %controlhwnd% 
PostMessage 0x201, , ,, %  "ahk_id" WinExist("msvb_lib_toolbar") ; Runs -->
PostMessage 0x202, , ,, %  "ahk_id" WinExist("msvb_lib_toolbar") ; Runs -->
