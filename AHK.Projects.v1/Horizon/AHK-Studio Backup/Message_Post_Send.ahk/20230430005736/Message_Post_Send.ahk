...
Loop % DllCall("GetClassName", uint, ControlHWND, uint, &charbuff, uint, 255 )
controlclassname .= Uint( NumGet( charbuff, A_Index-1, "uint" ) )
msgbox % controlclassname
;PostMessage 0x201,0,0,, %  window ; Runs -->
;PostMessage 0x202,0,0,, %  window ; Runs -->

;PostMessage,TB_PRESSBUTTON,,,, ahk_id 0x00040df4
PostMessage,0x0201,,,, ahk_id %ControlHwnd%
;Sleep 100
