...
; Begin Variables
Global root_ahk:= "AHK-Projects\"
Global root:= AHK_root_fld:= "C:\AHK-Studio\"
Global OneDrive:= "C:\Users\bacona\OneDrive - FM Global\"
Global teams:= "Teams - AHK - User Group\"
...
global sName:= A_ScriptName
global script_full_name:= sName "." script_ext
...
trayNotify(title, message, seconds = 1, options = 0) {
...
CountDown(disable_enable, delay = -1750){
...
updateTrayMenu() {
	...
	addTrayMenuOption("Updated with Nerd by Adam Bacon and Terry Keatts!`rCredit: Made with ❤️ by Bibek Aryal", "madeBy")
	addTrayMenuOption()
